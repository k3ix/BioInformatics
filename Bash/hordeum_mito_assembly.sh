...
do
	...
	exec 3<> config_mito.txt
		...
		echo "Seed Input            = /home/yahor/Fastq/cox1.fasta" >&3
		echo "Extend seed directly  = no" >&3
		echo "Reference sequence    = /home/yahor/Fastq/mito.fasta" >&3
		echo "Variance detection    = " >&3
		echo "Chloroplast sequence  = /home/yahor/Fastq/chloroplast.fasta" >&3
		echo "" >&3
		echo "" >&3
		echo "" >&3
		echo "Dataset 1:" >&3
